...
[atmospheric_wind_I_I__m_per_s] ...
    = atmospheric_velocity.execute(position_BI_I__m, ...
                    earth_quaternion_EI, ...
                    current_time__mjd, ...
                    ParametersEnvironment.atmospheric_velocity);
% Set output
EnvironmentConditions.EarthAtmosphere.atmospheric_wind_I_I__m_per_s ...
    = atmospheric_wind_I_I__m_per_s;
