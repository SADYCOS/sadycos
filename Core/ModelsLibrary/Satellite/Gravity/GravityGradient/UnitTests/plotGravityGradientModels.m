...
ParamsGGG ...
    = GravityGradientGeneral(inertia_B__kg_m2);
...
for i=1:numel(z_angles)
    for j=1:numel(y_angles)
        ...
        generalgravity_gradient_torque_BI_B__Nm = GravityGradientGeneral.execute(position_BI_I__m,...
                                                            attitude_quaternion_BI,...
                                                            gravitational_acceleration_I__m_per_s2,...
                                                            ParamsGGG.Parameters);

        % Spherical model based on point mass assumption of central body
        sphericalgravity_gradient_torque_BI_B__Nm = GravityGradientPointMass.execute(position_BI_I__m,...
                                                            attitude_quaternion_BI,...
