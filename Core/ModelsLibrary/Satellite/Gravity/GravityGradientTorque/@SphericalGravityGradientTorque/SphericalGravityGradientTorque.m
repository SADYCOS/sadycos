classdef SphericalGravityGradientTorque < ModelBase
    ...
    methods (Access = public)
        ...
        function obj = SphericalGravityGradientTorque(inertia__kg_m2,...
                                gravitational_parameter_central_body__m3_per_s2)
        % GravityGradientPointMass
        %
        %   Inputs:
        %   inertia__kg_m2: inertia of the spacecraft
        %   gravitational_parameter_central_body__m3_per_s2: constant
        %

        arguments
            inertia__kg_m2 (3,3) {mustBeReal}
            gravitational_parameter_central_body__m3_per_s2 (1,1) {mustBeReal,mustBePositive,mustBeFinite}
        end

            Parameters.inertia_B__kg_m2 = inertia__kg_m2;
            Parameters.gravitational_parameter_central_body__m3_per_s2 = gravitational_parameter_central_body__m3_per_s2;
