...
%% Transform gravity acceleration vector into inertial frame
gravity_acceleration_I__m_per_s2 = smu.unitQuat.att.transformVector(smu.unitQuat.invert(q_EI), a_E__m_per_s2);
dcm_IE = smu.unitQuat.att.toDcm(smu.unitQuat.invert(q_EI));
gravity_hessian_I__1_per_s2 = dcm_IE*H_E__1_per_s2*dcm_IE';
